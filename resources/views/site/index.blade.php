            ...
            <div class="container">
                ...
                <div class="wheel-container">
                    ...
                    <div class="service s2" main-item="1">
                        <img src="{{asset('img/service2.jpg')}}" alt="">
                    ...
                    <div class="service s4" main-item="3">
                        <img src="{{asset('img/service3.jpg')}}" alt="">
                    ...
                    <div class="service s6 end" main-item="5">
                        <img src="{{asset('img/service4.jpg')}}" alt="">
                    ...
                    <div class="service s3" main-item="2">
                        <img src="{{asset('img/service5.jpg')}}" alt="">
                    ...
                    <img src="{{asset('img/service6.jpg')}}" alt="">
                ...
                <div class="team_row">
                    ...
                    <div class="team_item current_info">
                        ...
                        <div class="team_img step">
                            <img src="{{asset('img/team2.jpg')}}" alt="" class="left_side">
                    ...
                    <div class="team_item current_info">
                        ...
                        <!-- Team img -->
                        <div class="team_img step">
                            <img src="{{asset('img/team4.jpg')}}" alt="" class="left_side">
                    ...
                    <div class="team_item current_info">
                        ...
                        <!-- Team img -->
                        <div class="team_img step">
                            <img src="{{asset('img/team6.jpg')}}" alt="" class="left_side">
                            <img src="{{asset('img/team7.jpg')}}" alt="">
                        </div> 
                    </div>                        
                </div> 
            </div> 
