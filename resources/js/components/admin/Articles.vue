<template>
    <div class="container">
        ...
        <v-btn color="success" block size="small" :to="newArticleLink">Добавить новую статью</v-btn>
        <br><br>
        <v-card>
...
const text = ref('Статья успешно удалена!');
const newArticleLink = "/home/create-art";
const search = ref('');
